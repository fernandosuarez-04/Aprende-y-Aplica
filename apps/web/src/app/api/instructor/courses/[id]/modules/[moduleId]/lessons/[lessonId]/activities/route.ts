...
export async function GET(
  ...
  try {
    ...
    // console.error('Error in GET /api/instructor/courses/[id]/modules/[moduleId]/lessons/[lessonId]/activities:', error)
    return NextResponse.json(
      { 
        success: false,
...
export async function POST(
  ...
  try {
    ...
    // console.error('Error in POST /api/instructor/courses/[id]/modules/[moduleId]/lessons/[lessonId]/activities:', error)
    return NextResponse.json(
      { 
        success: false,
