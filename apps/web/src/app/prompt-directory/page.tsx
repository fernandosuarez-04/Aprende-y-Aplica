        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-purple-300">Prompt Directory</span>
            </motion.div>
      ...
      >
        ...
        {!loading && !error && prompts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No se encontraron prompts</h3>
