-- CORRECCIÓN DE LA TABLA ROLE_SYNONYMS (VERSIÓN CORREGIDA)
-- Este archivo corrige los mapeos incorrectos en la tabla role_synonyms
-- basándose en los IDs reales de la tabla roles
-- MANEJA DUPLICADOS Y CONFLICTOS DE CLAVE ÚNICA

-- ==============================================
-- 1. LIMPIAR TABLA EXISTENTE
-- ==============================================
-- Limpiar todos los sinónimos existentes para evitar conflictos
