      ...
      <div className="min-h-screen bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          <div className="bg-red-900/20 border border-red-800 rounded-lg p-6 max-w-md">
            ...
            <p className="text-red-300 mb-4">{error || 'Comunidad no encontrada'}</p>
            <button
              onClick={() => router.back()}
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">Administración de comunidad</p>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-300">{community.member_count} miembros</span>
                </div>
                <div className="flex items-center space-x-2">
                  <DocumentTextIcon className="h-5 w-5 text-green-400" />
                  <span className="text-sm text-gray-300">{community.posts_count} posts</span>
                </div>
                <div className="flex items-center space-x-2">
                  <ChatBubbleLeftRightIcon className="h-5 w-5 text-yellow-400" />
                  <span className="text-sm text-gray-300">{community.comments_count} comentarios</span>
                </div>
                <div className="flex items-center space-x-2">
                  <VideoCameraIcon className="h-5 w-5 text-purple-400" />
                  <span className="text-sm text-gray-300">{community.videos_count} videos</span>
                </div>
              </div>
          ...
          <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                {posts.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400">No hay posts en esta comunidad</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {posts.map((post) => (
                      <div key={post.id} className="bg-gray-800 rounded-lg border border-gray-700 p-4">
              ...
              <div className="space-y-4">
                ...
                {members.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400">No hay miembros en esta comunidad</p>
                  </div>
                ) : (
                        ...
                        <div className="flex items-center space-x-3">
                           ...
                           <div className="flex space-x-1">
                             <button 
                               ...
                               className="p-1 text-gray-400 hover:text-green-400 hover:bg-green-900/20 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                             ...
                             <button 
                               ...
                               disabled={isProcessing === member.id}
                               className="p-1 text-gray-400 hover:text-red-400 hover:bg-red-900/20 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {activeTab === 'requests' && (
              <div className="space-y-4">
                ...
                {accessRequests.length === 0 ? (
                  <div className="text-center py-8">
                    <UserPlusIcon className="h-12 w-12 text-gray-600 mx-auto mb-4" />
                    <p className="text-gray-400">No hay solicitudes pendientes</p>
                    <p className="text-gray-500 text-sm mt-2">Usa el botón "Invitar Usuario" para agregar miembros directamente</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              {request.note && (
                                <p className="text-gray-300 text-sm mt-2">{request.note}</p>
                              )}
                           ...
                           <div className="flex space-x-2">
                             <button 
                               ...
                               className="p-2 text-gray-400 hover:text-green-400 hover:bg-green-900/20 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {activeTab === 'videos' && (
              <div className="space-y-4">
                ...
                {videos.length === 0 ? (
                  <div className="text-center py-8">
                    <VideoCameraIcon className="h-12 w-12 text-gray-600 mx-auto mb-4" />
                    <p className="text-gray-400">No hay videos en esta comunidad</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {videos.map((video) => (
                      <div key={video.id} className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex space-x-1">
                              <button className="p-1 text-gray-400 hover:text-blue-400 hover:bg-blue-900/20 rounded transition-colors">
                                <EyeIcon className="h-4 w-4" />
                              </button>
                              <button className="p-1 text-gray-400 hover:text-green-400 hover:bg-green-900/20 rounded transition-colors">
                                <PencilIcon className="h-4 w-4" />
                              </button>
