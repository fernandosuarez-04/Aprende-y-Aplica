-- Script para verificar y poblar las tablas lookup
...
UNION ALL
SELECT 'tamanos_empresa' as tabla, COUNT(*) as total FROM tamanos_empresa
UNION ALL
SELECT 'sectores' as tabla, COUNT(*) as total FROM sectores;

-- 2. Si las tablas están vacías, poblar con datos de ejemplo
-- Insertar áreas
...
-- 4. Verificar las relaciones con user_perfil
SELECT 
  up.id,
  up.cargo_titulo,
  up.pais,
