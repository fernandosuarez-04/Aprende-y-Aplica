...
export function ConditionalNavbar({ children }: ConditionalNavbarProps) {
  ...
  const isStudyPlannerDashboardPage = pathname.startsWith('/study-planner/dashboard');
