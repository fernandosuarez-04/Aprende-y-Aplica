      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white">Subir Paquete SCORM</h1>
        ...
        {/* Selectores */}
        <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {organizations.length === 0 ? (
                <div className="px-4 py-3 border-2 border-red-300 dark:border-red-700 rounded-lg bg-red-50 dark:bg-red-900/20">
        ...
        {selectedCourseId && selectedOrgId && (
          <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-neutral-900 dark:text-white">Paquetes SCORM del Curso</h2>
              {packages.length > 0 && (
