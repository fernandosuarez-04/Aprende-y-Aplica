  ...
  return (
    <Menu as="div" className="relative">
      <Menu.Button
        ...
        className="relative p-2 rounded-lg hover:bg-gray-700/50 transition-colors duration-200"
      >
        <BellIcon className="w-6 h-6 text-gray-400 hover:text-white transition-colors duration-200" />
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-80 bg-gray-800 rounded-lg shadow-xl border border-gray-700 py-2 z-50 max-h-96 overflow-hidden">
          {/* Header */}
