...
export const isProgressComplete = (progress: number, threshold: number = 90): boolean => {
...
export const generateFingerprint = (userAgent: string, screenResolution: string): string => {
