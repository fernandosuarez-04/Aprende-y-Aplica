    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative h-3 bg-carbon-700/50 dark:bg-carbon-800/50 rounded-full overflow-hidden shadow-inner border border-carbon-600/30">
        ...
        <motion.div
          ...
          className="absolute inset-0 h-full bg-gradient-to-r from-primary via-blue-500 to-success rounded-full shadow-lg shadow-primary/30"
        >
          {/* Shine effect */}
          <motion.div
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary/60 via-transparent to-success/60 rounded-full blur-sm" />
