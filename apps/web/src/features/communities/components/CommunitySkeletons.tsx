    ...
    <div className="space-y-6 animate-pulse">
      {[1, 2, 3].map((i) => (
        <div key={i} className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700">
          ...
          {/* Image placeholder */}
          <div className="h-64 bg-gray-200 dark:bg-slate-700 rounded-lg mb-4" />
...
export function CommunityHeaderSkeleton() {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl p-6 animate-pulse border border-gray-200 dark:border-slate-700">
      ...
      <div className="flex gap-6 mt-4 pt-4 border-t border-gray-200 dark:border-slate-700">
      ...
      <div className="space-y-3">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="h-3 bg-gray-200 dark:bg-slate-700 rounded w-24 mb-1" />
