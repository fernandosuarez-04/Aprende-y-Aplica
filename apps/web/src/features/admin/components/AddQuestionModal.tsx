        ...
        <div className="relative bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 p-6">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Nueva Pregunta</h2>
                <p className="text-white/80 text-sm">Crear una nueva pregunta para el cuestionario</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="bg-gray-800/50 border-t border-gray-700 p-6">
          <div className="flex justify-end space-x-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
