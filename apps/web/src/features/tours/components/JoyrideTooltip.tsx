...
/**
 * Custom Joyride tooltip component with default styling.
 * Can be enhanced later to use organization styles.
 */
export const JoyrideTooltip: React.FC<TooltipRenderProps> = ({
  ...
  // Default theme colors (can be enhanced later with context)
  const theme = {
    background: '#1E2329',
    text: '#FFFFFF',
    primary: '#0A2540',
  ...
  return (
    <div
      ...
      className="relative flex flex-col rounded-2xl shadow-2xl overflow-hidden w-[90vw] sm:w-[380px] max-w-sm max-h-[85vh] border-0"
      style={{
    ...
    >
      ...
      {/* Footer / Controls */}
      <div 
        className="flex items-center justify-between mt-auto p-6 pt-4 border-t shrink-0 relative z-10 bg-inherit" 
