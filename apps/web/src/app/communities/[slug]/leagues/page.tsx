      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-white/70">Cargando sistema de ligas...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            {currentUser && (
              ...
              >
                <motion.div
                  className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm border border-slate-600/50 rounded-2xl p-8"
                    ...
                    {pointsSystem && Object.entries(pointsSystem).map(([action, points]) => (
                      ...
                      >
                        <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-3">
                          {action === 'post' && <Target className="w-6 h-6 text-blue-400" />}
                          {action === 'comment' && <Star className="w-6 h-6 text-blue-400" />}
                          {action === 'reaction' && <Heart className="w-6 h-6 text-blue-400" />}
                          {action === 'popular_post' && <Flame className="w-6 h-6 text-blue-400" />}
                        </div>
              ...
              >
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  {filteredMembers.map((member, index) => (
                    <motion.div
                      key={member.id}
                      className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg hover:bg-slate-600/30 transition-colors"
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <motion.button
                        ...
                        className="w-full p-4 bg-slate-700/30 rounded-lg hover:bg-slate-600/30 transition-colors text-left"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-right">
                            <div className="text-sm text-yellow-400">+{game.points} pts</div>
                          </div>
                        </div>
                      </motion.button>
                    ))}
                  ...
                  <div className="mt-6 pt-6 border-t border-slate-700/50">
                    <h4 className="text-sm font-semibold text-white mb-3">Estadísticas</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-slate-400">Juegos jugados</span>
                      ...
                      <div className="flex justify-between text-sm">
                        <span className="text-slate-400">Mejor puntuación</span>
                        <span className="text-white">0</span>
                      </div>
                    </div>
                  </div>
