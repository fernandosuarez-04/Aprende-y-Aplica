    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-xl border border-gray-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <h2 className="text-xl font-bold text-white">Detalles de la App</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            {app.long_description && (
              <div className="mt-4">
                <h5 className="text-md font-medium text-white mb-2">Descripción Detallada</h5>
          ...
          {app.use_cases && app.use_cases.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-white mb-3">Casos de Uso</h4>
              <div className="flex flex-wrap gap-2">
          ...
          {/* Plataformas */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-3">Disponibilidad en Plataformas</h4>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-gray-800 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-white">{app.view_count.toLocaleString()}</div>
                <div className="text-sm text-gray-400">Vistas</div>
              </div>
              
              <div className="bg-gray-800 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-white">{app.like_count.toLocaleString()}</div>
                <div className="text-sm text-gray-400">Likes</div>
              </div>
              
              <div className="bg-gray-800 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-white">{app.rating.toFixed(1)}</div>
                <div className="text-sm text-gray-400">Rating</div>
              </div>
              
              <div className="bg-gray-800 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-white">{app.rating_count.toLocaleString()}</div>
