        ...
        <>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-rose-500/5 to-transparent opacity-50" />
              ...
              <div className="relative p-6 sm:p-8">
                ...
                <div className="flex justify-center mb-4">
                  ...
                  >
                    ...
                    {/* Icono principal */}
                    <div className="relative w-20 h-20 bg-gradient-to-br from-red-500 to-rose-600 rounded-full flex items-center justify-center shadow-lg">
                      <motion.div
                      ...
                      >
                        <AlertCircle className="w-10 h-10 text-white" fill="currentColor" />
                      </motion.div>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-3 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-semibold rounded-lg shadow-lg transition-all duration-200"
                  >
                    Entendido
                  </motion.button>
                </motion.div>
              ...
              {duration > 0 && (
                <motion.div
                  ...
                  className="h-1 bg-gradient-to-r from-red-500 to-rose-600"
                />
              )}
            </motion.div>
          </div>
